...
const ExportModal = ({ keys, handleChange, handleSubmit, setOpenModal, open, data, loading, title }: TProps) => {
								...
								<CustomSwitch
									...
									onChange={(e: any) => {
										...
										handleChange(
											'list',
											checked
												? [...data?.list, item] // add item
												: data?.list.filter((i: any) => i !== item) // remove item
										)
									}}
