...
const QualityControlForm = ({ handleSubmit, handleChange, data, setOpenModal, showResponse }: TProps) => {
			...
			<div className="h-auto">
				<div className="grid grid-cols-1 md:grid-cols-2 justify-between gap-3 items-center">
					<div className="mb-5 md:col-span-2 flex justify-start">
						<ProfileImageUpload url={showResponse?.data?.avatar?.url} onChange={e => handleChange('avatar', e)} />
					</div>
