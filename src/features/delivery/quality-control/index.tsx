...
import { useQualityControlsHook, useUpdateQualityControl } from './hooks'
...
const QualityControl = () => {
	...
	const {
		...
		setOpenUnBlockModal,
		unblockLoading
	} = useQualityControlsHook()
	const { updateLoading, showLoading, handleSubmit, handleChange, values, openEditModal, setOpenEditModal, handleOpenModal } = useUpdateQualityControl()
	return (
		<Card>
			<CardHeader>
				{permission('show') && (
