...
import { UserBlockApi, UserUnblockApi, createUserApi, deleteUserApi, updateUserApi } from '@/features/customers/customers/api'
...
export const useGetAllUsers = (params?: any) => {
	...
	const { data, loading, error, getPage, onSearch, search, active_data } = useFetchData(getUsers, selector, params)
...
export const useUsersHook = () => {
	...
	const { deleteLoading, handleDelete, openDeleteModal, setOpenDeleteModal, handleDeleteModal } = useDeleteUser()
