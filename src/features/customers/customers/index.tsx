...
import { useUpdateUser, useUsersHook } from './hooks'
...
const CustomersContent = () => {
	...
	const { updateLoading, showLoading, handleSubmit, handleChange, values, openEditModal, setOpenEditModal, handleOpenModal } = useUpdateUser()
	return (
		<Card>
			<CardHeader>
				{permission('show') && (
				...
				{permission('destroy') && (
					<ConfirmModal loading={deleteLoading} handleClick={handleDelete} openModal={openDeleteModal} setOpenModal={setOpenDeleteModal} message={t('confirm_delete_user')} btnValue={t('delete')} />
				)}

				<ConfirmModal loading={blockLoading} handleClick={handleBlockModal} openModal={openBlockModal} setOpenModal={setOpenBlockModal} message={t('confirm_block_user')} btnValue={t('block')} />
