...
const SizesForm = ({ handleSubmit, handleChange, data, setOpenModal }: TProps) => {
	...
	return (
		<form onSubmit={handleSubmit}>
			<div className="grid grid-cols-1 lg:grid-cols-2 justify-between gap-5 mb-8 items-center">
				...
				<FormInput value={data.carbohydrates} onChange={e => handleChange('carbohydrates', e.target.value)} label={t('carbohydrates')} />
				<FormInput value={data.protiens} onChange={e => handleChange('protiens', e.target.value)} label={t('proteins')} />
			</div>
