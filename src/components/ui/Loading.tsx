export const Loading = () => {
	return (
		<div className="absolute w-full h-full left-0 top-0 inset-0 z-10 cursor-wait">
			<div className="relative items-center block w-full h-full bg-[#ffffffab] rounded-md shadow-md">
...
export function LoadingPage() {
	return (
		<div data-testid="loading" className="flex space-x-2 justify-center items-center bg-bg-primary/5 fixed inset-0 z-[100] backdrop-blur-lg">
			<span className="sr-only">Loading...</span>
